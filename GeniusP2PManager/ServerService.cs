...
{
    //Repris des exemples fourni par le SDK
    ...
    // net.p2p://MeshName/servicemodesamples/chat"
    ...
    public class CustomPeerResolverService : ICustomPeerResolver
    {
        ...
        public int Register(string meshId, PeerNodeAddress nodeAddress)
        {
            ...
            Console.WriteLine("Added {0} to meshId {1}", nodeAddress.EndpointAddress.Uri.AbsoluteUri, meshId);
        ...
        public void Unregister(int registrationId)
        {
            ...
            lock (registrationTable)
            {
                ...
                lock (meshIdTable)
                {
                    ...
                    Console.WriteLine("Removing {0} from meshId {1}", addresses[registrationId].EndpointAddress.Uri.AbsoluteUri, registration.MeshId);
